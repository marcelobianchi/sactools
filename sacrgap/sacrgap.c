...
int main(int argc, char **argv)
{
  ...
  if ((n>0) && (dir==NULL))
    ...
    fprintf(stderr,"Error, no file nor directory to process or both.\n");
    return -1;
  }
...
void showHelp()
{
  ...
  fprintf(stderr,"  sacrgap [-v] [-h] [-g <gap value>] [-m <0|1>] [-e <file ending string>] <-d <dir>|-f <file1> ... <fileN>>\n");
  fprintf(stderr,"\n\tMethod 0: Mean\n");
  ...
  fprintf(stderr,"\t-m) Use linear trend or mean value to correct gaps.\n");
...
int
removegaps (SACHEAD * h, float *y, float gapval,int method)
{
