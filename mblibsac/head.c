...
static SACHEADDEF x[] = {
	...
	{"user0", offsetof(SACHEAD, user0), 1, 0, 0},
	{"user1", offsetof(SACHEAD, user1), 1, 0, 0},
	{"user2", offsetof(SACHEAD, user2), 1, 0, 0},
	{"user3", offsetof(SACHEAD, user3), 1, 0, 0},
	{"user4", offsetof(SACHEAD, user4), 1, 0, 0},
	{"user5", offsetof(SACHEAD, user5), 1, 0, 0},
	{"user6", offsetof(SACHEAD, user6), 1, 0, 0},
	{"user7", offsetof(SACHEAD, user7), 1, 0, 0},
	{"user8", offsetof(SACHEAD, user8), 1, 0, 0},
	{"user9", offsetof(SACHEAD, user9), 1, 0, 0},
